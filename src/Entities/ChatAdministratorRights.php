...
/**
 * ChatAdministratorRights Entity
 ...
 * @property bool $can_post_stories;
 * @property bool $can_edit_stories;
 * @property bool $can_delete_stories;
 ...
 */
class ChatAdministratorRights extends EntityBase
{
